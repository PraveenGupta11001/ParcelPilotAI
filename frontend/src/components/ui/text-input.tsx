...
export const TextInput = React.forwardRef<HTMLInputElement, { icon?: any; className?: string; inputClassName?: string;[x: string]: any }>(
    ({ icon: Icon, className, inputClassName, ...props }, ref) => (
